# Ankiniki Documentation

Welcome to the comprehensive documentation for Ankiniki, the Anki companion tool designed for engineers and developers.
...
- **[Quick Start Tutorial](getting-started/quick-start.md)** - Create your first flashcards in 5 minutes
- **[AnkiConnect Setup](getting-started/anki-setup.md)** - Configure Anki for integration
...
- **[Deck Management](user-guides/desktop-app/deck-management.md)** - Organizing your cards
...
- **[System Architecture](developer/architecture.md)** - Understanding the codebase
- **[Contributing Guidelines](developer/contributing.md)** - How to contribute to the project
- **[API Reference](developer/api-reference.md)** - Complete backend API documentation
- **[Building & Packaging](developer/building.md)** - Build and distribution process
...
- **[VS Code Extension](integration/vscode-extension.md)** - IDE integration (coming soon)
- **[AI Features](integration/ai-features.md)** - AI-powered card generation (coming soon)
...
- **[AnkiConnect Problems](troubleshooting/anki-connection.md)** - Connection and sync issues
- **[Performance Issues](troubleshooting/performance.md)** - Optimization and speed problems
...
- **[Keyboard Shortcuts](reference/keyboard-shortcuts.md)** - Complete shortcut list
- **[File Formats](reference/file-formats.md)** - Supported import/export formats
- **[Glossary](reference/glossary.md)** - Terms and definitions

## 🇯🇵 日本語ドキュメント (Japanese Documentation)

Japanese translations are available in the [`ja/`](ja/) directory:

- **[日本語版 README](ja/README.md)** - Japanese documentation index
- **[はじめに](ja/はじめに/)** - Getting started guides in Japanese
- **[ユーザーガイド](ja/ユーザーガイド/)** - User guides in Japanese
- **[開発者向け](ja/開発者向け/)** - Developer documentation in Japanese
...
- **Use the command line** → [CLI Overview](user-guides/cli/overview.md)
- **Integrate with my API** → [API Overview](user-guides/api/overview.md)
- **Contribute to the project** → [Contributing Guidelines](developer/contributing.md)
...
- **🏢 Enterprise**: Review [API Documentation](user-guides/api/) and [Integration Guides](integration/)
...
- **[Documentation Plan](DOCUMENTATION_PLAN.md)** - Comprehensive documentation strategy
...
2. **Search the [GitHub Issues](https://github.com/iray-tno/ankiniki/issues)**
3. **Create a new issue** with the `documentation` label
4. **Join the community** discussions

---

**Version**: 0.1.0 | **Last Updated**: December 2024 | **Language**: English, 日本語